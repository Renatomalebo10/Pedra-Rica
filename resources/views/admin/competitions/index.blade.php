...
@section('page-title', 'Competições')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Competições</h1>
            <p class="text-gray-500 mt-1">Gerir competições desportivas</p>
        </div>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium text-gray-900">{{ $competition->name }}</span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-600 line-clamp-1">{{ $competition->description ?? '-' }}</span>
                            </td>
                                        ...
                                        <div x-show="showDelete" x-cloak class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4" x-transition>
                                            <div class="bg-white rounded-xl shadow-xl p-6 max-w-sm w-full" @click.away="showDelete = false">
                                                <div class="text-center">
                                                    ...
                                                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Eliminar competição?</h3>
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="px-6 py-12 text-center">
                                ...
                                <p class="text-gray-500">Nenhuma competição encontrada</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
